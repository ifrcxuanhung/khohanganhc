						...
						?>
                            <table class="table  table-bordered">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                         <td width="50%" class="td_custom font_size_new" align="center"><div class="col-md-12 bg_trading"><h6 class="color_h6 cus_type"><?php translate('head_lots'); ?><i class="m-icon-swapright m-icon-white icon_sma"></i></h6><h6 class="cus_h6 load_modals" edit_for="lots" data-target="#modals" data-toggle="modal" data-type="input"  data-value="<?php echo $simul_settings['order']['lots'][0]['name'];?>"><?php echo $simul_settings['order']['lots'][0]['name'];?></h6></div></td>

                                        <td width="50%" class="td_custom font_size_new" align="center"><div class="col-md-12 bg_trading"><h6 class="color_h6 cus_type"><?php translate('head_price'); ?><i class="m-icon-swapright m-icon-white icon_sma"></i></h6><h6 class="cus_h6 load_modals" edit_for="price" data-target="#modals" data-toggle="modal" data-type="input" data-value="<?php echo ($price_futures !='-' && (isset($maxspd['tick']))) ? number_format(ceiling($price_futures,$maxspd['tick']),$get_decimal,'.',$get_comma):'-' ;?>">
										<?php echo ($price_futures !='-' && (isset($maxspd['tick']))) ? number_format(ceiling($price_futures,$maxspd['tick']),$get_decimal,'.',$get_comma):'-' ;?>
                                        </h6></div></td>
                                    ...
                                    <tr>
                                        ...
                                        <a style="min-height: 40px; line-height:18px; background-color: #ee2222 ; box-shadow: 0 3px 6px rgba(0, 0, 0, 0.2), 0 3px 6px rgba(0, 0, 0, 0.26);" class="btn btn-lg green form-control" data-target="#sell_buy" data-toggle="modal"><strong><?php translate('btn_sell'); ?></strong></a>
                                        </div></td>
                                        <td width="50%" class="td_custom font_size_new" align="center"><div class="col-md-12">  <a style="min-height: 40px; line-height:18px;  background-color: #00a800 ; box-shadow: 0 3px 6px rgba(0, 0, 0, 0.2), 0 3px 6px rgba(0, 0, 0, 0.26);" class="btn btn-lg green form-control" data-target="#sell_buy" data-toggle="modal"><strong><?php translate('btn_buy'); ?></strong></a></div></td>
                            ...
                            <table class="table  table-bordered table-hover table_color table_cus">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td_custom font_size_13 order_qbid" align="left" style="line-height:26px;"><?php echo $row_future['qbid'];?></td>
                                         <?php
                        	//get format any value
