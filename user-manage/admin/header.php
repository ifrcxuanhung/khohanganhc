	...
	<nav class="navbar navbar-default navbar-fixed-top">
	  <div class="container">
        ...
        <?php $url = explode("user-manage",$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
			$baseURL = $url[0];
		?>
               <a href="http://<?php echo $baseURL;?>" style="text-decoration:none;"> <h3 style="margin-top: 18px; color:#fcd116 !important; font-weight: bold;">Quản lý thông tin <span style="color: red;"> user</span></h3></a>
