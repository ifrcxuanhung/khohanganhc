<div class="portlet box red blocks" style="margin-bottom:5px; position:relative">
    ...
    <div class="portlet-body background_portlet">
        ...
        <div class="c-contact">
            ...
            <form action="#" class="margin-top-20">
                
                <div class="col-md-6">
                    <div class="form-group" style="padding-right: 20px;">
                        <input type="text" class="form-control input-md" placeholder="<?php translate('holder_your_name'); ?>"> </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group" style="padding-left: 20px;">
                        <input type="text" class="form-control input-md" placeholder="<?php translate('holder_your_email'); ?>"> </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="form-group" style="padding-right: 40px;">
                        <input type="text" class="form-control input-lg" placeholder="<?php translate('holder_input_capcha_here'); ?>..."> 
                    </div>
                </div>
                <div class="col-md-5" style="text-align: right;">
                    <button class="btn btn-lg green" style="width:30%" type="submit"><?php translate('btn_submit'); ?></button>
                </div>
