...
.webapp-btn:hover > h3 {color:#00ccff !important;}
.webapp-btn h3{ color:#<?php echo $start_title_color['value'];?> !important; font-size:<?php echo $start_title_size['value'];?>px !important;}
